...
`,
  ...
  breaks: [String.raw`break`, [new Break()]],
  rules: [String.raw`@ > 100`, [new Rule(">", new Literal(100))]],
  arrays: [
    String.raw`[1, 2, 3, 4]`,
    [new Arr([new Literal(1), new Literal(2), new Literal(3), new Literal(4)])],
  ],
  functionDeclaration: [
    String.raw`fnc foo(a:arr[int], b:boo, c:str):
